...
{
    [PropertyDrawer(typeof(PpsActionHeader))]
    public class PpsActionHeaderPropertyDrawer : PropertyDrawer
    {
        ...
        public override object OnGUI(GUIContent label, object obj, bool isSceneObject, params object[] attributes)
        {
            ...
            if (_bgColor == Color.black)
            {
                ColorUtility.TryParseHtmlString("#CCDCE4", out _bgColor);
            }
            _rect = GUILayoutUtility.GetLastRect();
            GUIDrawRect(_rect, _bgColor);
